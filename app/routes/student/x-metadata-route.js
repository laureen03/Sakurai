SakuraiWebapp.StudentMetadataRoute = SakuraiWebapp.StudentSectionRoute.extend(SakuraiWebapp.ResetScroll,{
    ...
    setupController: function(controller, model) {
        ...
        if (selectedTermTaxonomy == SakuraiWebapp.Section.NURSING_TOPICS){
