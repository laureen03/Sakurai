 ...
 */
SakuraiWebapp.ChoiceManageQuestionComponent = Ember.Component.extend(
    ...
    initInteraction: function (question, createMode) {
        ...
        if (createMode) {
            ...
            component.set('correctResponseVal', interaction.correctResponse.value[0]);
    ...
    getInteractions: function () {
        ...
        return new Em.RSVP.Promise( function(resolve, reject) {
            ...
            var interaction = SakuraiWebapp.Interaction.create({}),
                ...
                answerChoice, fixed, text, correctId;

            interaction.setProperties({
                "type": SakuraiWebapp.Question.CHOICE,
                "subType": SakuraiWebapp.Question.MULTIPLE_CHOICE,
                "minChoices": 1,
                "maxChoices": 1 });
